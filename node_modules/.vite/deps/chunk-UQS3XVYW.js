// node_modules/@tanstack/router-devtools-core/dist/index-DX7UIGS3.js
var sharedConfig = {
  context: void 0,
  registry: void 0,
  effects: void 0,
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-kcMbkHXI-IAFFKGZU.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-KIEU40vQ-IJ7FATP6.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-UQS3XVYW.js.map
